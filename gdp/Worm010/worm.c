...
enum ResCode initializeWorm(int headpos_y, int headpos_x, enum WormHeading dir, enum ColorPairs color);
void showWorm();
...
void showWorm()
{
    ...
    placeItem(theworm_headpos_y, theworm_headpos_x, SYMBOL_WORM_INNER_ELEMENT, theworm_wcolor);
}
